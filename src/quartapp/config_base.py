...
from quartapp.approaches.schemas import Context, DataPoint, JSONDataPoint, RetrievalResponse, Thought
...
class AppConfigBase(ABC):
    ...
    def _get_data_points(self, documents: list[Document]) -> DataPoint:
