...
async def test_chat_with_empty_messages_list(client_mock):
    ...
    response: Response = await client_mock.post(
        "/chat",
        json={"sessionState": "test-session", "messages": [], "context": {"overrides": {"retrieval_mode": "vector"}}},
    )
...
async def test_chat_stream_with_empty_messages_list(client_mock):
    ...
    response: Response = await client_mock.post(
        "/chat/stream",
        json={"session_state": "test-session", "messages": [], "context": {"overrides": {"retrieval_mode": "rag"}}},
    )
