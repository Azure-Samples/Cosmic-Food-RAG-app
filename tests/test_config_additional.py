...
from quartapp.approaches.schemas import AIChatRoles, Context, DataPoint, Message, Thought
...
async def test_run_rag_no_results_with_answer(app_config_mock):
    ...
    app_config_mock.setup.rag.run = AsyncMock(return_value=([], '{"response": "test response", "rephrased_response": "test"}'))
